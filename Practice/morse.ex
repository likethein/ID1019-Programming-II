defmodule Morse do
  ...
  def decode([?- | signal], {:node, _, left, _}, table) do
    decode(signal, left, table)
  end

  def decode([?. | signal], {:node, _, _, right}, table) do
    decode(signal, right, table)
  end

  def decode([?\s | signal], {:node, s, _, _}, table) do
    [s | decode(signal, table, table)]
  end
